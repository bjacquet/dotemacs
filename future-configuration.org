...
(use-package org-roam
  ...
  (org-roam-capture-templates
   '(("f" "friction log" plain
      (file "~/.config/emacs/roam-templates/friction-log.org")
      :if-new (file+head "fritction-logs/${slug}.org" "#+title: ${title}\n#+filetags: FrictionLog")
      :unnarrowed t)
     ("m" "team meeting" plain
      (file "~/.config/emacs/roam-templates/team-meeting.org")
     ...
     ("n" "quick note" plain
      ...
      :unnarrowed t)
     ("t" "ticket" plain
      (file "~/.config/emacs/roam-templates/ticket-document-platform.org")
