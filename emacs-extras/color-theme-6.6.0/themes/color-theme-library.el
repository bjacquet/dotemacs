  ...
  (color-theme-install
   '(color-theme-aalto-dark
    ...
    (font-lock-builtin-face ((t (:foreground "LightSteelBlue"))))
					...
					; (font-lock-comment-face ((t (:foreground "OrangeRed"))))
    (font-lock-comment-face ((t (:background "white" :foreground "OrangeRed"))))
  ...
  (color-theme-install
   '(color-theme-tango
     ...
     ((help-highlight-face . underline)
      (list-matching-lines-face . bold)
      (widget-mouse-face . highlight))
      (default ((t (:stipple nil :background "black" :foreground "White" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 103 :width normal :family "adobe-courier"))))
     (bold ((t (:bold t :weight bold))))
     (bold-italic ((t (:italic t :bold t :slant italic :weight bold))))
     (border ((t (:background "#888a85"))))
     (cursor ((t (:background "#666666"))))     
     (font-lock-builtin-face ((t (:foreground "#729fcf"))))
     (font-lock-comment-face ((t (:foreground "#888a85"))))
     (font-lock-constant-face ((t (:foreground "#ad7fa8"))))
     (font-lock-doc-face ((t (:foreground "#888a85"))))
     (font-lock-function-name-face ((t (:foreground "#729fcf" :bold t :weight bold))))
     (font-lock-keyword-face ((t (:foreground "#fcaf3e" :bold t :weight bold))))
