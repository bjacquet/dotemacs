;;;-----------------------------------------------------------------------------
;;; Description
;;;	Defines an editing mode for Visual Basic.
;;;	
;;; History
;;;	Date		Author		Description
;;;	01/03/13	Toni		Changed definitions
;;;					  VISUAL-BASIC-MODE
;;;-----------------------------------------------------------------------------
...
(defvar visual-basic-wild-files "*.frm *.bas *.cls *.asp *.inc"
...
;;;History
;;;	Date		Author		Description
;;;	01/03/13	Toni		Commented the setting of an hook that
;;;					was replacing tab characters by space
;;;					characters upon saving a visual basic
;;;					buffer. This way tab characters are
;;;					preserved.
;;;-----------------------------------------------------------------------------
...
\\{visual-basic-mode-map}"
  ...
  ;; Commented in order to prevent tab characters from being replaced by space
  ;; characters upon saving a visual basic buffer.
