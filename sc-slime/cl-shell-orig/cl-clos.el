...
(put 'defclass   'lisp-indent-function 'defun)
(put 'with-slots 'lisp-indent-function 2)
(put 'with-accessors 'lisp-indent-function 2)
(put 'with-added-methods 'lisp-indent-function 1)
(put 'symbol-macrolet 'lisp-indent-function 1)
(put 'generic-flet 'lisp-indent-function 1)
(put 'generic-function 'lisp-indent-function 1)
(put 'generic-labels 'lisp-indent-function 1)
...
;;; methods!
;; This shouldn't be done while loading. Moved to cl-shell.el
;; (cl-send-string
;;  "#+(and LCL4.0 CLOS)
;;   (progn
