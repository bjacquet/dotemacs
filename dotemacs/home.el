...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (auto-compile all-the-icons-dired all-the-icons dashboard react-snippets js-react-redux-yasnippets yasnippet-snippets yasnippet panda-theme ranger treemacs-magit treemacs-icons-dired treemacs-projectile goto-last-change json-mode detour golden-ratio htmlize flychek jsx-mode flyspell-popup rinari ag handlebars-mode handlebars-sgml-mode slim-mode sr-speedbar robe wn-mode winpoint tangotango-theme tango-2-theme smart-mode-line rust-mode paredit pager naquadah-theme multiple-cursors markdown-mode haskell-mode expand-region diminish darktooth-theme color-theme-modern chess birds-of-paradise-plus-theme arbitools)))
